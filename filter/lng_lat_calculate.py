...
if __name__ == '__main__':
    ...
    print('theta0 -1:', theta)
    theta = angleFromCoordinate(114.524145, 30.505588, 114.528145, 30.505588)
    ...
    print(temp)
    distance = get_x_y_distance([114.524145, 30.505588], [114.528145, 30.505588], debug=True)
    print('distance_x_y', distance)
