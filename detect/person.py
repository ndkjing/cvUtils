...
class DetectVideo:
    ...
    def send_data(self, frame):
        ...
        if save_name:
            ...
            upload_file.post_descip(data=send_data, url=url_descpi)

    def detect_video(self, src=None):
...
if __name__ == '__main__':
    ...
    # 获取地址  (萤石云产品序列号)
    src = get_eviz_url.get_url(serial_str='F77671789')
    # 检测视频流
    obj.detect_video(src=src)
